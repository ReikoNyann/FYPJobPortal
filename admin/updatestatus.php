...
<html>
    <head>
        <link rel="stylesheet" href="../css/admin/saupdatestatus.css">
    <header>
        <title>Mu2WIL System Admin View Update Status Page</title>
    </header>
    </head>
<body>
    <main>
        ...
        <div class="updateform">
            <h2>Update User Enquiry</h2>
            <form action="" method="post">
                <label>Enquiry Title: </label><br>
                
                <label>Enquiry Details: </label><br>
